...
dataroot="data/aclImdb_small"
dataroot="data/aclImdb_full"
train_data, test_data, valid_data = createData(dataroot)
...
def train(model, iterator, optimizer, criterion):
    ...
    for batch in iterator:
        ...
        ret = model(text, text_lengths)

        predictions = ret.squeeze(1)
