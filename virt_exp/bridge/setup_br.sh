...
sudo ip route add default via 192.168.171.2
sudo ip netns exec net1 ip route add default via 192.168.171.2
...
sudo ifconfig br 192.168.171.200 up
sudo ip route add default via 192.168.171.2 dev br
...
#sudo brctl addif br veth0 
#
#sudo ip addr add 192.168.1.200/24 dev br
#sudo ip link set dev br up
